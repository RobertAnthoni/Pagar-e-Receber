        ...
        <div class="pb-10 flex justify-between">
            ...
            <div class="relative flex gap-x-3">
                ...
                <div class="text-sm leading-6">
                    <label for="show_conciliado" class="font-medium text-gray-900">Ver Lançamentos Pagos.</label>
                </div>
            </div>

            <a href="{{ route('create.contaspagar') }}">
                <x-button>
                    Novo Lançamento
                </x-button>
            </a>
                    ...
                    @foreach ($ContasPagar as $lan)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap">
                                <a href="{{ route('edit.contaspagar', [$lan->id]) }}"
