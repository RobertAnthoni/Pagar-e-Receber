                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <div
                                    ...
                                    <select disabled wire:model.lazy="id_fornec" name="id_fornec" id="id_fornec"
                            ...
                            @if ($status != 'Pago')
                                <div class="md:col-span-5 text-right pt-3">
                                    <x-danger-button class="mx-3 my-2" wire:click="delete">Excluir Lançamento Completo</x-danger-button>
                                    <x-button class="mx-3 my-2">Conferir Pagamento</x-button>
                                </div>
                            @endif
                        </div>
                    </div>
