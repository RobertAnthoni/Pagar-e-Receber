                        ...
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <div
                                    ...
                                    <select wire:model.lazy="id_client" name="id_client" id="id_client"
                                        ...
                                        <option value="1">Joabe - Empresa X</option>
                                        <option value="2">Frank - Empresa Y</option>
                                        <option value="3">Paloma - Empresa Z</option>
                                    </select>
                                ...
                                @if ($this->plano_pag == 'U')
                                    <div class="relative flex gap-x-3">
                                        <div class="flex h-6 items-center">
                                            <input wire:model.lazy="lan_pag" id="lan_pag" name="lan_pag"
                                                type="checkbox"
